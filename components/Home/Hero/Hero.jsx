...
const Hero = () => {
    return (
        <section className="mx-auto flex max-w-[980px] flex-col justify-center items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
            <a className="inline-flex items-center rounded-lg bg-muted px-3 py-1 text-sm font-medium" href="/Introduction">
                ...
                <span className='relative z-10'>Introducing React Nex</span>
            ...
            <h1 className="text-center text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1] z-10">Build beautiful <span className='gradient-text'>UI's </span>faster</h1>
            <span className="max-w-[502px] text-center text-lg font-light z-10">Cut the bloat, boost your development. React-nex offers a lightweight approach to UI components. Accessible. Open Source.</span>
            <div className="flex w-full items-center justify-center space-x-4 py-4 md:pb-10 z-10">
                ...
                <a target="_blank" rel="noreferrer" className="bg-white dark:bg-black inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2" href="https://github.com/Sahilwagh03/React-Nex-Components/tree/main/src/components">
