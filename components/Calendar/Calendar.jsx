...
const CalendarView = ({
    ...
    return (
        <div className={cn("max-w-[260px] w-[100%] border-2 dark:border-[#d3d3d314] dark:border-2 rounded-md p-[20px] dark:bg-transparent", timer && 'rounded-tr-none rounded-br-none')}>
            <div className='w-[100%]'>
